...
for index in call["strike"]:
    ...
    profit1[index]=payoff1[index]+cost2 #short 先收權利金
    


    #short futures at 9800 position
    
    payoff2[index]=fprice-index
...
plt.ylim((-700,700))
plt.plot(call["profit1"],color='red', label='Short Put profit')
plt.plot(call["profit2"],color='blue', label='Short Futures profit')
plt.plot(call["Tprofit"],color='orange', label='Protective Put Value')
plt.legend(loc='best')
plt.show()
